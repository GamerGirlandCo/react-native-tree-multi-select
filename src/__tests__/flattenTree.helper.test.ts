...
describe('getFlattenedTreeData', () => {
    ...
    test('should correctly flatten a simple tree', () => {
        ...
        expect(result).toEqual([
            { id: '1', name: 'node1', level: 0, children: simpleNodes?.[0]?.children , index: 1},
            { id: '1.1', name: 'node1.1', level: 1, children: simpleNodes?.[0]?.children?.[0]?.children, index: 1 },
            { id: '1.1.1', name: 'node1.1.1', level: 2, index: 1 },
            { id: '1.1.2', name: 'node1.1.2', level: 2, index: 2 },
            { id: '1.1.3', name: 'node1.1.3', level: 2, index: 3 },
            { id: '1.2', name: 'node1.2', level: 1, children: simpleNodes?.[0]?.children?.[1]?.children, index: 2},
            { id: '1.2.1', name: 'node1.2.1', level: 2, index: 1 },
            { id: '1.2.2', name: 'node1.2.2', level: 2, index: 2 },
            { id: '1.2.3', name: 'node1.2.3', level: 2, index: 3 },
            { id: '1.3', name: 'node1.3', level: 1, children: simpleNodes?.[0]?.children?.[2]?.children, index: 3 },
            { id: '1.3.1', name: 'node1.3.1', level: 2, index: 1 },
            { id: '1.3.2', name: 'node1.3.2', level: 2, index: 2 },
            { id: '1.3.3', name: 'node1.3.3', level: 2, index: 3 },
        ]);
    });
